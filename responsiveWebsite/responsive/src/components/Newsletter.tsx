      ...
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
        ...
        <div className="my-4">
          ...
          <p>
            ...
            <span className=" relative inline-block text-[#00df9a] cursor-pointer after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-[#00df9a] after:transition-all after:duration-300 hover:after:w-full">
              Privacy Policy.
            </span>
          </p>
        </div>
